...
<head>
    ...
    <style>
        ...
        .rules-list li::before { content: '⚽'; margin-right: 10px; }
...
<div class="quiz-container" id="quizBox">
    <div class="intro" id="startScreen">
        ...
        <ul class="rules-list">
            ...
            <li><strong>15 sekundi</strong> za svaki šut (pitanje).</li>
            <li>Brzina donosi bolju poziciju na tabeli!</li>
        </ul>

        <div class="warning-box">
            ⚠️ <strong>Sudijska opomena:</strong><br>
            Refresh stranice se kažnjava gubitkom poena na trenutnom pitanju!
        </div>

        <button class="btn" onclick="startQuiz()">Istrči na teren 🚀</button>
    </div>
...
// --- TVOJA PITANJA ---
const questions = [
    { q: "Prvi golman Muje Hrnjice nije?", a: ["Mehić", "Fajković", "Sabljaković"], c: 0 },
    { q: "Koja zemlja je osvojila Svjetsko prvenstvo 2018?", a: ["Francuska", "Hrvatska", "Brazil"], c: 0 },
    { q: "Koliko igrača ima u standardnom nogometnom timu?", a: ["10", "11", "12"], c: 1 },
    { q: "Koji klub ima nadimak 'Red Devils'?", a: ["Liverpool", "Manchester United", "Chelsea"], c: 1 },
    { q: "Koji igrač ima najviše osvojenih Zlatnih lopti (Ballon d'Or)?", a: ["Lionel Messi", "Cristiano Ronaldo", "Neymar"], c: 0 },
    { q: "Koji stadion je domaći teren za Real Madrid?", a: ["Santiago Bernabeu", "Camp Nou", "Old Trafford"], c: 0 },
    { q: "Koji igrač je širom svijeta poznat kao CR7?", a: ["Ronaldinho", "Cristiano Ronaldo", "Ronaldo Nazario"], c: 1 },
    { q: "Koja reprezentacija nosi nadimak 'Oranje'?", a: ["Nizozemska", "Njemačka", "Belgija"], c: 0 },
    ...
    { q: "Koji igrač je dugo godina nosio broj 10 u Barceloni?", a: ["Lionel Messi", "Xavi", "Iniesta"], c: 0 },
    { q: "Koja zemlja je domaćin EURO 2024?", a: ["Njemačka", "Francuska", "Italija"], c: 0 },
    { q: "Koji klub iz Torina ima najviše titula u Italiji?", a: ["Juventus", "Inter", "Milan"], c: 0 },
    { q: "Koji igrač ima nadimak 'The Egyptian King'?", a: ["Mohamed Salah", "Sadio Mane", "Eden Hazard"], c: 0 },
    { q: "Koja liga se smatra najjačom na svijetu (Engleska)?", a: ["Serie A", "La Liga", "Premier League"], c: 2 }
];
...
window.onload = function() {
    if (localStorage.getItem("sportKvizUToqu") === "da") {
        ...
        alert("Pokušali ste osvježiti stranicu! Šut promašen (pitanje je netačno).");
        index++; 
        startQuiz(true);
    }
};
