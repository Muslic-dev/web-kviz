...
<head>
    <meta charset="UTF-8">
    <title>Opće Znanje | Kvizomanija</title>
    ...
    <style>
        ...
        .rules-list li::before { content: '✔️'; margin-right: 10px; color: #f59e0b; }
...
<div class="quiz-container" id="quizBox">
    <div class="intro" id="startScreen">
        ...
        <h2>Opće Znanje</h2>
        <p class="desc">Pokaži koliko poznaješ svijet oko sebe!</p>
        ...
        <div class="warning-box">
            ...
            Nemoj osvježavati stranicu! To se računa kao netačan odgovor.
        </div>

        <button class="btn" onclick="startQuiz()">Pokreni Kviz 🚀</button>
    </div>
...
const questions = [
    ...
    { q: "Koliko kontinenata postoji (po najčešćem modelu)?", a: ["5", "6", "7"], c: 2 },
    { q: "Najveća planeta u Sunčevom sistemu je?", a: ["Mars", "Jupiter", "Zemlja"], c: 1 },
    { q: "Ko je napisao 'Na Drini ćuprija'?", a: ["Ivo Andrić", "Mak Dizdar", "Meša Selimović"], c: 0 },
    { q: "Hemijski simbol za vodu je?", a: ["H2O", "CO2", "O2"], c: 0 },
    { q: "Koja se smatra najdužom rijekom na svijetu?", a: ["Nil", "Amazon", "Dunav"], c: 0 },
    { q: "Koji je najveći okean na Zemlji?", a: ["Atlantski", "Indijski", "Pacifički"], c: 2 },
    ...
    { q: "Koja je površinski najveća država svijeta?", a: ["SAD", "Rusija", "Kina"], c: 1 },
    { q: "Koliko slova ima engleska abeceda?", a: ["24", "25", "26"], c: 2 },
    { q: "Koja životinja je simbol Australije?", a: ["Lav", "Kengur", "Slon"], c: 1 },
    { q: "Najviša planina na svijetu je?", a: ["Mount Everest", "Alpe", "Mont Blanc"], c: 0 },
    { q: "Koja boja nastaje miješanjem plave i žute?", a: ["Zelena", "Ljubičasta", "Narandžasta"], c: 0 }
];
...
window.onload = function() {
    if (localStorage.getItem("opceKvizUToqu") === "da") {
        ...
        alert("Pokušali ste osvježiti stranicu! Pitanje je označeno kao netačno.");
        index++; 
        startQuiz(true);
    }
};
...
function finishQuiz() {
    ...
    document.getElementById("quizBox").innerHTML = `
        <div class="result" style="animation: fadeIn 0.5s;">
            ...
            <h2 style="color: #d97706;">Kviz završen!</h2>
